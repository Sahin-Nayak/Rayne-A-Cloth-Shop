...
<section id="header">
  ...
  <div class="navbar_all">
    <ul id="navbar">
      ...
      <li><a class="active" onclick="window.location.href='blog.php';">Blog</a></li>
          ...
          <section id="blog">
            <div class="blog-box">
                ...
                <div class="blog-details">
                    <h4 id="blogh4">The Cotton-Jersey Zip-up Hoddie</h4>
                    <p id="blogp">Kickstarter man braid godard coloring book, Raclette waistcoat selfies Yr 
